...
@Component({
  selector: 'app-instruments-medium',
  templateUrl: './instruments-medium.component.html',
  styleUrls: ['./instruments-medium.component.scss'],
})
export class InstrumentsMediumComponent implements OnInit {
  time = 0;
